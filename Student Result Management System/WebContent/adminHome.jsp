...
<center><img src="sastra.png" width="200" height="100">
...
<div class="w3-container">
  <div class="w3-bar w3-black">
    ...
    <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'Tokyo')">Registered Students</button>
     <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'Tokyo1')">All Student Result</button>
